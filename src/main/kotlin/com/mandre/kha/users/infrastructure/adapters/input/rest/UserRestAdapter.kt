...
class UserController(
    ...
    suspend fun getUserById(@PathVariable id: String): ResponseEntity<GetUserByIdResponse> {
        val user = findOneUserUseCase.findOne(id)
        return user?.let { ResponseEntity.ok(userRestMapper.toGetUserByIdResponse(it)) }
